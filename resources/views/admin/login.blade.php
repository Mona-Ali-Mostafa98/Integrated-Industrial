                        ...
                        <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="#" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block fs-1" style="color: #1B5E20;">الصناعيه المتكامله
                                    </span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-2 text-dark">تسجيل الدخول</h5>
                                    ...
                                    <form class="row g-3 needs-validation" novalidateaction
                                        ...
                                        <div class="col-12 mb-4">
                                            <button class="btn w-100 text-light fs-4" type="submit"
                                                style="background-color: #1B5E20;">تسجيل الدخول</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
